...
def make_crawler_config_get(authenticated_user: str) -> dict:
    target_url = construct_parameterized_url(endpoint_constants.CONFIG_MS_URL + endpoint_constants.CRAWLER_CONFIGURATION,\
